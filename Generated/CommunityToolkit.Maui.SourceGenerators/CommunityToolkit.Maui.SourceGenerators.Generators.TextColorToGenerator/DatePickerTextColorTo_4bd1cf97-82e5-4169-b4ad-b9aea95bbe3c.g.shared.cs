...
public static partial class ColorAnimationExtensions_DatePicker
{
    /// <summary>
    ...
    public static Task<bool> TextColorTo(this Microsoft.Maui.Controls.DatePicker element, Color color, uint rate = 16u, uint length = 250u, Easing? easing = null)
    {
        ...
        catch (ArgumentException aex)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"{aex.GetType().Name} thrown in {typeof(ColorAnimationExtensions_DatePicker).FullName}: {aex.Message}");
